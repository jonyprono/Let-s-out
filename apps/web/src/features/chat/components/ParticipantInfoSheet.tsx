...
import { ConversationMember } from '../api'
...
export function ParticipantInfoSheet({ member, eventTitle, eventCoverUrl, onClose }: ParticipantInfoSheetProps) {
  ...
  const handleAddFriend = async () => {
    try {
      await sendFriendRequest.mutateAsync(member.userId)
      setRequestSent(true)
