          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-gray-50 dark:bg-[#222222] border border-gray-200 dark:border-[#333333] rounded-2xl px-4 py-4 text-[15px] font-medium outline-none focus:border-[#9747FF] focus:bg-white dark:bg-[#1A1A1A] transition-all"
                placeholder="••••••••"
              />
              <button
                type="button"
