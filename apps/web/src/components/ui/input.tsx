      ...
      <div className="relative w-full">
        ...
        <input
          ...
          className={cn(
            ...
            "flex h-[var(--input-height)] w-full rounded-[var(--input-radius)] border border-[var(--border-primary)] bg-[var(--color-background-primary)] px-4 font-inter text-[14px] font-medium text-[var(--color-text-primary)] transition-all duration-150 placeholder:text-[var(--color-text-placeholder)] placeholder:font-normal focus:outline-none focus:border-2 focus:border-[var(--border-brand-primary)] disabled:cursor-not-allowed disabled:opacity-50",
