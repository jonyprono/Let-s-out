...
export function PhoneInputField({
  ...
  return (
    ...
    <div className="relative flex items-center w-full h-[48px] rounded-[8px] border border-[var(--border-default)] bg-white overflow-hidden focus-within:border-2 focus-within:border-[var(--border-brand-primary)] transition-all duration-150">
      <CountryPicker
        value={country}
