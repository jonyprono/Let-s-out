...
export function AdminAdminsPage() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      {showAdd && (
        <div className="p-6 rounded-3xl border border-white/10 bg-white/[0.02] backdrop-blur-xl shadow-2xl animate-in slide-in-from-top-4 space-y-4">
          ...
          <div className="flex justify-end gap-3 pt-2">
            <button onClick={() => setShowAdd(false)} className="px-6 py-3 rounded-xl font-bold text-white/50 hover:bg-white/5 transition-colors">Annuler</button>
            <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {admins?.map((admin: AdminUser) => (
          <div key={admin.id} className="p-5 rounded-3xl border border-white/10 bg-white/[0.02] backdrop-blur-md shadow-lg group hover:bg-white/[0.04] transition-colors flex items-center justify-between gap-4">
