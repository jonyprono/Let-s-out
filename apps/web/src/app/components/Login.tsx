    ...
    return (
      <div className="auth-flow w-full h-full flex flex-col bg-background-default text-foreground transition-colors overflow-hidden relative">
        <div className="flex-1 px-6 pt-6 sm:pt-10 flex flex-col overflow-y-auto pb-4 max-w-[400px] mx-auto w-full">
          ...
          <h1 className="text-[26px] font-bold text-gray-900 mb-2 text-center tracking-tight">Connectez-vous</h1>
          <p className="text-[14px] text-gray-600 mb-8 text-center leading-relaxed">
            Rejoignez des événements près de vous et vivez des expériences inoubliables.
          </p>

          <label className="block text-[14px] font-medium text-gray-800 mb-2">Numéro de téléphone</label>
          <div className="flex items-center h-[52px] border border-gray-300 rounded-[12px] bg-white overflow-hidden mb-5 focus-within:border-[#F58220] focus-within:ring-1 focus-within:ring-[#F58220] transition-all">
            <CountryPicker
              value={country}
          ...
          <label className="block text-[14px] font-medium text-gray-800 mb-2">Mot de passe</label>
          <div className="relative mb-2">
            <input
              ...
              onKeyDown={e => e.key === 'Enter' && handleLogin()}
              placeholder=""
              className="w-full h-[52px] px-4 border border-gray-300 rounded-[12px] text-[15px] focus:outline-none focus:border-[#F58220] focus:ring-1 focus:ring-[#F58220] transition-all pr-12"
            />
          ...
          <div className="text-right mb-6">
            <button type="button" onClick={onForgotPassword} className="text-[13px] text-[#F58220] underline underline-offset-2 hover:opacity-80 transition-opacity">
              Mot de passe oublié?
            </button>
          </div>
          ...
          <button
            ...
            className="w-full bg-[#F58220] hover:bg-[#E6781D] text-white h-[52px] rounded-full font-semibold text-[15px] mb-6 flex items-center justify-center gap-2 disabled:opacity-50 active:scale-[0.98] transition-all shadow-sm"
          >
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-gray-600 text-[13px]">Ou</span>
            <div className="flex-1 h-[1px] bg-gray-300" />
          </div>
          ...
          <button
            ...
            className="w-full bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 h-[52px] rounded-[100px] font-semibold text-[15px] mb-8 flex items-center justify-center gap-3 active:scale-[0.98] transition-all shadow-sm"
          >
          ...
          <div className="mt-auto flex flex-col items-center justify-center gap-4 text-center pb-2">
            <p className="text-[14px] text-gray-600">
              ...
              <button onClick={onSignup} className="text-[#F58220] underline underline-offset-2 hover:opacity-80 transition-opacity">
                Inscrivez-vous
              </button>
            </p>
