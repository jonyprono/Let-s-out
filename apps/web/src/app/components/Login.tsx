  ...
  return (
    <div className="auth-flow w-full h-full flex flex-col bg-[#F8F9FA] text-foreground overflow-hidden">
      <div className="h-full px-5 py-4 flex flex-col w-full max-w-[420px] mx-auto overflow-y-auto scrollbar-hide bg-white shadow-sm sm:rounded-[40px] sm:my-auto sm:h-auto sm:max-h-[90vh]">
        ...
        <h1 className="text-[20px] font-extrabold text-[#1A1A1A] mb-1 text-center tracking-tight">Connectez-vous</h1>
        <p className="text-[13px] text-[#4A5568] mb-4 text-center leading-snug px-2">
        ...
        <div className="flex flex-col gap-3 mb-2">
          ...
          {/* Téléphone */}
          <div>
            <label className="block text-[12px] font-medium text-[#1A1A1A] mb-1">Numéro de téléphone</label>
            <div className="flex items-stretch h-[48px] border border-[#E2E8F0] rounded-[14px] bg-white focus-within:border-[#FF951A] focus-within:ring-1 focus-within:ring-[#FF951A] transition-all">
              <CountryPicker
                value={country}
                onChange={(c) => { setCountry(c); resetPhone() }}
                className="flex items-center gap-1.5 px-3 bg-transparent whitespace-nowrap border-r border-[#E2E8F0] text-[13px] text-[#1A1A1A] shrink-0 font-medium"
              />
              <input
                type="tel"
                inputMode="numeric"
          ...
          {/* Mot de passe */}
          <div>
            <label className="block text-[12px] font-medium text-[#1A1A1A] mb-1">Mot de passe</label>
            <div className="relative">
              <input
                ...
                onKeyDown={e => e.key === 'Enter' && handleLogin()}
                placeholder="••••••••"
                className="w-full h-[48px] px-3 pr-12 border border-[#E2E8F0] rounded-[14px] text-[14px] focus:outline-none focus:border-[#FF951A] focus:ring-1 focus:ring-[#FF951A] transition-all text-[#1A1A1A]"
              />
              <button
                type="button"
        ...
        <div className="text-right mb-4">
          <button
            ...
            className="text-[12px] font-medium text-[#FF951A] hover:underline underline-offset-2 transition-all"
          >
            Mot de passe oublié?
          </button>
        </div>
        ...
        <button
          ...
          className="w-full bg-[#FF951A] hover:bg-[#E68617] text-white h-[48px] rounded-[16px] font-bold text-[14px] mb-4 flex items-center justify-center disabled:opacity-60 active:scale-[0.98] transition-all shadow-sm"
        >
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-[#A0AEC0] text-[11px] font-medium uppercase tracking-wider">Ou</span>
          <div className="flex-1 h-[1px] bg-[#E2E8F0]" />
        </div>
        ...
        <button
          ...
          className="w-full bg-white border border-[#E2E8F0] text-[#1A1A1A] hover:bg-gray-50 h-[48px] rounded-[16px] font-semibold text-[13px] mb-4 flex items-center justify-center gap-2 active:scale-[0.98] disabled:opacity-60 transition-all shadow-sm"
        >
          {googleLoading ? (
        ...
        <div className="flex flex-col items-center gap-2 mt-auto pt-2">
          ...
          <p className="text-[10px] text-[#A0AEC0] leading-tight text-center px-4">
