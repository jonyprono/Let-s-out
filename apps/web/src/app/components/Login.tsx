...
export function Login({ onSignup, onForgotPassword }: LoginProps) {
  ...
  const handleLogin = () => {
    ...
    return (
      <div className="auth-flow w-full h-full flex flex-col bg-white text-foreground overflow-y-auto">
        <div className="px-6 pt-10 pb-8 flex flex-col w-full max-w-[420px] mx-auto min-h-full">

          {/* Logo */}
          <div className="flex justify-center mb-5 mt-2">
            <img src="/logo.png" alt="Lets Out Logo" className="w-[90px] h-auto object-contain" />
          </div>

          <h1 className="text-[26px] font-bold text-[#1A1A1A] mb-2 text-center tracking-tight">Connectez-vous</h1>
          <p className="text-[14px] text-[#718096] mb-8 text-center leading-relaxed">
            Rejoignez des événements près de vous et vivez des expériences inoubliables.
          </p>

          {/* Téléphone */}
          <label className="block text-[14px] font-semibold text-[#1A1A1A] mb-1.5">Numéro de téléphone</label>
          <div className="flex items-stretch h-[52px] border border-[#D0D5DD] rounded-xl bg-white mb-4 focus-within:border-[#FF951A] focus-within:ring-1 focus-within:ring-[#FF951A] transition-all">
            <CountryPicker
              value={country}
              onChange={(c) => { setCountry(c); resetPhone() }}
              className="flex items-center gap-1.5 px-3 bg-transparent whitespace-nowrap border-r border-[#D0D5DD] text-[14px] text-[#1A1A1A] shrink-0"
            />
            <input
              type="tel"
              inputMode="numeric"
              ...
              className="flex-1 min-w-0 px-3 text-[15px] bg-transparent text-[#1A1A1A] placeholder-[#A0AEC0] focus:outline-none"
            />
          </div>

          {/* Mot de passe */}
          <label className="block text-[14px] font-semibold text-[#1A1A1A] mb-1.5">Mot de passe</label>
          <div className="relative mb-1">
            <input
              ...
              onKeyDown={e => e.key === 'Enter' && handleLogin()}
              placeholder=""
              className="w-full h-[52px] px-4 pr-12 border border-[#D0D5DD] rounded-xl text-[15px] focus:outline-none focus:border-[#FF951A] focus:ring-1 focus:ring-[#FF951A] transition-all text-[#1A1A1A]"
            />
            <button
              type="button"
          ...
          <div className="text-right mb-6">
            <button
              ...
              className="text-[13px] font-semibold text-[#FF951A] hover:underline underline-offset-2 transition-all"
            >
              Mot de passe oublié?
            </button>
          </div>
          ...
          <button
            ...
            className="w-full bg-[#FF951A] hover:bg-[#E68617] text-white h-[52px] rounded-xl font-bold text-[16px] mb-5 flex items-center justify-center disabled:opacity-60 active:scale-[0.98] transition-all"
          >
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-[#718096] text-[13px]">Ou</span>
            <div className="flex-1 h-[1px] bg-[#D0D5DD]" />
          </div>
          ...
          <button
            ...
            className="w-full bg-white border border-[#D0D5DD] text-[#1A1A1A] hover:bg-gray-50 h-[52px] rounded-xl font-semibold text-[15px] mb-8 flex items-center justify-center gap-3 active:scale-[0.98] transition-all"
          >
          ...
          <div className="flex flex-col items-center gap-4 text-center mt-auto">
            ...
            <p className="text-[11px] text-[#718096] leading-relaxed px-2 text-center">
              En continuant, vous acceptez nos{' '}
              <button className="text-[#FF951A] font-semibold hover:underline">Conditions d'Utilisation</button>
              {' '}et notre{' '}
              <button className="text-[#FF951A] font-semibold hover:underline">Politique de Confidentialité</button>
            </p>
          </div>
