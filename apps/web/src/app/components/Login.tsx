    ...
    <div className="auth-flow w-full h-full flex flex-col bg-white text-foreground overflow-hidden">
      <div className="h-full px-5 py-6 flex flex-col w-full max-w-[420px] mx-auto overflow-y-auto scrollbar-hide">
        ...
        <button
          ...
          className="w-full bg-[#FF951A] hover:bg-[#E68617] text-white h-[48px] rounded-xl font-bold text-[15px] mb-4 flex items-center justify-center disabled:opacity-60 active:scale-[0.98] transition-all"
        >
        ...
        <button
          ...
          className="w-full bg-white border border-[#D0D5DD] text-[#1A1A1A] hover:bg-gray-50 h-[48px] rounded-xl font-semibold text-[14px] mb-5 flex items-center justify-center gap-3 active:scale-[0.98] disabled:opacity-60 transition-all"
        >
          {googleLoading ? (
            <span className="text-[13px] text-[#718096]">Connexion...</span>
          ) : (
            <>
        ...
        <div className="flex flex-col items-center gap-3 text-center mt-auto">
          ...
          <p className="text-[10px] text-[#718096] leading-relaxed px-2 text-center">
