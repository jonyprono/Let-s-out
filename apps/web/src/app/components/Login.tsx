...
export function Login({ onSignup, onForgotPassword }: LoginProps) {
  ...
  const handleLogin = () => {
    ...
    return (
      <div className="min-h-[100dvh] w-full flex items-center justify-center bg-gray-50 py-6 px-4">
        <div className="w-full max-w-[390px] h-[844px] max-h-[90dvh] bg-white rounded-[40px] shadow-2xl relative overflow-hidden flex flex-col border-[6px] border-white ring-1 ring-gray-200">
          <div className="flex-1 px-6 pt-14 pb-8 flex flex-col overflow-y-auto w-full scrollbar-hide">
            {/* Logo */}
            <div className="flex justify-center mb-6 mt-4">
              <img src="/logo.png" alt="Lets Out Logo" className="w-[100px] h-auto object-contain" />
            </div>

            <h1 className="text-[28px] font-bold text-[#1A1A1A] mb-3 text-center tracking-tight">Connectez-vous</h1>
            <p className="text-[15px] text-[#718096] mb-10 text-center leading-relaxed px-2">
