  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        coverUrl,
        poolTarget: enablePool && poolTarget ? parseFloat(poolTarget) : null,
        poolMode: enablePool && poolTarget ? (poolMinAmount ? 'minimum' : 'libre') : null,
        poolMinAmount: enablePool && poolMinAmount ? parseFloat(poolMinAmount) : null,
        poolDescription: enablePool && poolDescription ? poolDescription.trim() : null,
