  ...
  return (
    <div className="h-[100dvh] overflow-y-auto bg-background-white p-5 pb-10">
      ...
      <div className="prose prose-sm text-gray-700 space-y-4">
        ...
        <h2 className="text-lg font-semibold text-black dark:text-white mt-6 mb-2">1. Acceptation des conditions</h2>
        <p>
          En créant un compte sur Let's Out (notamment via l'authentification par SMS), vous acceptez d'être
          lié par ces conditions.
        </p>

        <h2 className="text-lg font-semibold text-black dark:text-white mt-6 mb-2">2. Utilisation du service</h2>
        <p>
        ...
        <h2 className="text-lg font-semibold text-black dark:text-white mt-6 mb-2">3. Contenu utilisateur</h2>
        <p>
        ...
        <h2 className="text-lg font-semibold text-black dark:text-white mt-6 mb-2">4. Responsabilité</h2>
        <p>
