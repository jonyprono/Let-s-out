...
export function AuthLayout() {
  return (
    ...
    >
      <div
        className="force-light w-full sm:max-w-[430px] sm:max-h-[932px] bg-white text-black overflow-y-auto overflow-x-hidden relative flex flex-col sm:shadow-2xl sm:rounded-[40px]"
        style={{
          minHeight: '100dvh',
